...
From LogRel Require Import Utils BasicAst Notations Context NormalForms Weakening UntypedReduction
  GenericTyping DeclarativeTyping DeclarativeInstance DeepTyping.
...
Section MoreSubst.
  ...
  Proof.
    ...
    - change (↑ >> tRel) with (tRel⟨↑⟩).
      ...
      eapply id_subst; boundary.
    - refold.
      eapply wfTermConv.
      econstructor; [constructor; tea; boundary|now econstructor].
  ...
  Proof.
    ...
    assert [|- Γ,, A] by (constructor; boundary).
    repeat match goal with |- _ × _ => split end.
    all: intros * Hty.
